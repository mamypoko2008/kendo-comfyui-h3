...
- Image: ghcr.io/mamypoko2008/kendo-comfyui-h3:v2.1.2
...
- Adds Auto/locked 32-bit generation seeds, editable seed values, randomize, reuse-latest, and reuse-from-history controls.
- Stores the seed with each new history item without storing or rendering its prompt.
- Enlarges image-reference previews into a responsive thumbnail grid with filenames and overlay remove actions.
